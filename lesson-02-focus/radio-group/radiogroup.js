  ...
  RadioGroup.prototype.handleKeyDown = function(e) {
    switch(e.keyCode) {
      ...
      case VK_LEFT: {
        ...
        //If you are pressing left or up key, check if the position is 0, if yes, then move the
        //focus to the last element. Else, go one up.
      ...
      case VK_RIGHT: {
        ...
        // This seems like a good place to do some stuff :)
        //If you are pressing right or down key, check if the focus is on the last element,
        //if yes, then the focus should go on top, else move one down.
